...
File: core/tools/prompt_builder.py
Description: Prompt Builder for assembling system prompts for AI providers.
...
class PromptBuilder:
    ...
    Usage:
        ...
        prompt = builder.build("chatgpt", brand_context="...", language="zh")

    Attributes:
        PROVIDER_PROMPTS: Mapping of provider names to prompt files.
        SUPPORTED_LANGUAGES: List of supported language codes.
    """

    # Provider to prompt file mapping
    # All files must exist in prompts/polling/
    # Language-specific versions use suffix: polling_chatgpt_zh.md, etc.
    PROVIDER_PROMPTS = {
    ...
    def _validate_prompts(self):
        ...
        Logs warnings for missing files but does not raise errors
        to allow for lazy file creation.
        """
        missing = []
    ...
    def _get_context_label(self, language: str) -> str:
        ...
        Returns localized label for the context section based on
        ...
        Returns:
            Localized context label string.
        """
        labels = {
            "zh": "相关信息：",
            "en": "Relevant context:",
